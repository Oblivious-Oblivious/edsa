#ifndef __EDSA_TABLE_MODULE_SPEC_H_
#define __EDSA_TABLE_MODULE_SPEC_H_
...
module(T_table, {
  ...
  it("reads a file with 100000 random words", {
    ...
    char *words =
      string_new(file_handler_read("spec/table/examples/random_words.txt"));
  ...
  it("reads a big file with 1000000 random words", {
    ...
    char *words =
      string_new(file_handler_read("spec/table/examples/big_list.txt"));
    char **arr = string_split(words, '\n');
